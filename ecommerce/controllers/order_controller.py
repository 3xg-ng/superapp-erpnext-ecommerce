...
@frappe.whitelist(allow_guest=True)
def create_new_order(shipping_address, lga, post_code, subtotal, discount, total, payment_method, user_id, status):
    return create_order(shipping_address, lga, post_code, subtotal, discount, total, payment_method, user_id, status)
