...
@frappe.whitelist(allow_guest=True)
def update_cart_item(user_id, item_code, product_name, image, seller_name, price, quantity):
    return update_cart_quantity(user_id, item_code, product_name, image, seller_name, price, quantity)
